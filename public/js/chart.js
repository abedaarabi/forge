...
Autodesk.ADN.Viewing.Extension.Chart = function(viewer, options) {
  ...
  _self.load = function() {
    getAllLeafComponents(function(components) {
      ...
      _elementIds.push(
        createDropdownMenu("Graph Type", { top: 50, left: 330 }, [
          {
            label: "Pie",
            handler: function() {
              _graphType = "pie";
  ...
  function createDropdownMenu(title, pos, menuItems, selectedItemIdx) {
    ...
    var html = [
      ...
      '<label id="' +
        labelId +
        '" style="font: normal 14px Times New Roman">' +
        title +
        "</label>",
    ...
    menuItems.forEach(function(menuItem) {
      ...
      var itemHtml =
        '<li id="' + itemId + '"><a href="">' + menuItem.label + "</a></li>";
...
Autodesk.ADN.Viewing.Extension.Chart.prototype = Object.create(
