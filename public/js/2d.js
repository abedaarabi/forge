...
Autodesk.Sample.Navigator = function(viewer, options) {
  ...
  _self.load = function() {
    ...
    viewables = viewer.bubble.search({ type: "geometry", role: "2d" });
    ...
    createUI = function() {
      ...
      button1.onClick = function(e) {
        if (_panel == null) {
          _panel = new Autodesk.Viewing.UI.DockingPanel(
            viewer.container,
            "NavigatorPanel",
            "Navigator"
          );
...
Autodesk.Sample.Navigator.prototype = Object.create(
