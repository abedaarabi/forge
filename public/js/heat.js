...
//     this.createShadeMaterialWithOffset = this.createShadeMaterialWithOffset.bind(
//       this
//     );
//     this.getBounds = this.getBounds.bind(this);
//     this.processSelection = this.processSelection.bind(this);
//     this.computeClickRelativeToFloorPosition = this.computeClickRelativeToFloorPosition.bind(
//       this
//     );
...
//       let intersectPoint = this.viewer.clientToWorld(
//         event.clientX,
//         event.clientY,
//         true
//       ).intersectPoint;
//       let offset = this.computeClickRelativeToFloorPosition(
//         intersectPoint,
//         this.bounds,
//         this.textureCoords
//       );
...
//       this.myMaterial = this.createShadeMaterialWithOffset(
//         offset.X,
//         offset.Y,
//         this.bounds
//       );
...
//       viewer.model
//         .getFragmentList()
//         .setMaterial(this.floorFragmentID, this.myMaterial);
...
//     materials.addMaterial("MyTextureShaderMaterial", material, true);
...
//     this.viewer.model.getFragmentList().getWorldBounds(fragId, bBox);
