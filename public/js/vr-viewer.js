...
//     position
//       .applyQuaternion(new THREE.Quaternion().fromArray(pose.orientation))
//       .multiplyScalar(_scale * RADIUS);
...
//     if (toolConfig.webVR_orbitModel) this.modeFusion(pose);
//     else this.modeWalkthrough(pose);

//     if (_standing)
//       //MB: perhaps add configurable user height option in settings menu
...
//  * @private
//  */
// Autodesk.Viewing.Extensions.WebVR.VRExtension.populateDefaultOptions = function(
//   options
// ) {
...
//     _stereoRenderContext = new Autodesk.Viewing.Extensions.WebVR.StereoRenderContext(
//       _vrDisplay,
//       _camera,
//       _HUD,
//       toolConfig
...
//       var cursor = new Autodesk.Viewing.Extensions.WebVR.Cursor(
//         viewer.impl,
//         viewer.autocam,
//         _vrDisplay.modelScaleFactor,
//         camYup
...
//     var icons = ["back.png", "zoomin.png", "zoomout.png", "next.png"];
...
//     if (!tmp && _menu.visible) this.onVisible(camera);
//     /*
//         // fade in/out
...
//       _menu.children[0].children[0].children[prevMenuIdx].material.color.setHex(
//         DEFAULT_COLOR
//       );
//     }
//     prevMenuIdx = Math.floor(
//       (menuRotOffset + _menu.quaternion.y + 0.14) * 4.54 * 4
//     );
//     if (prevMenuIdx >= 0 && prevMenuIdx < 4) {
//       _menu.children[0].children[0].children[prevMenuIdx].material.color.setHex(
//         0xaaaaff
...
//     if (USE_YUP) hitpt.z += STANDING_HEIGHT;
//     else hitpt.y += STANDING_HEIGHT;
